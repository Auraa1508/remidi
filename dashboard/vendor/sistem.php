...
$sql = "insert into tb_siswa(Nama,Kelas,Jurusan,Alamat,JenisKelamin) VALUES ('$nama','$kelas','$jurusan','$alamat','$jk')";
...
$edit ="UPDATE tb_siswa SET Nama='".$enama."', Kelas='".$ekelas."', Jurusan='".$ejurusan."', Alamat='".$ealamat."', JenisKelamin='".$ejk."' WHERE No =".$id;
